...
export function generateMetadata({ params }: RunesPageProps) {
  return {
    title: `Viego ${ROLE_LABELS[params.role as Role]} Runes — 4ViegoMains`,
    description: `Best Viego rune pages for ${ROLE_LABELS[params.role as Role]}.`,
  }
}

export default function RunesPage({
  params,
}: RunesPageProps): React.ReactElement {
          ...
          <div className="flex-1">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-400">
                Optimal rune pages and secondary builds for Viego in the {ROLE_LABELS[role]} role.
              </p>
            </div>
