...
export function generateMetadata({ params }: GuidesPageProps) {
  return {
    title: `Viego ${ROLE_LABELS[params.role as Role]} Guides — 4ViegoMains`,
    description: `Comprehensive Viego guides for ${ROLE_LABELS[params.role as Role]} with strategy and tips.`,
  }
}

export default function GuidesPage({
  params,
}: GuidesPageProps): React.ReactElement {
          ...
          <div className="flex-1">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-400">
                In-depth strategy guides and gameplay tips for mastering Viego in the {ROLE_LABELS[role]} role.
              </p>
            </div>
